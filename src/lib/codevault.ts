...
export const PRODUCTS: Product[] = [
  ...
  { id: 5, name: "Zender", category: "SMS / WhatsApp SaaS", description: "Messaging gateway platform for SMS and WhatsApp.", icon: "MessageSquare", demoUrl: "DEMO_URL_HERE", image: zenderImg.url },
  ...
  { id: 17, name: "BetLab", category: "Sports Betting", description: "Sports betting platform with markets and slips.", icon: "Trophy", demoUrl: "DEMO_URL_HERE", image: betlabImg.url },
  { id: 18, name: "66qrcode", category: "AI QR / Barcode Tools", description: "QR/barcode generator with URL shortening tools.", icon: "QrCode", demoUrl: "DEMO_URL_HERE", image: qrcode66Img.url },
  { id: 19, name: "Stocky", category: "POS / Inventory / HRM", description: "Inventory, sales and staff management suite.", icon: "Boxes", demoUrl: "DEMO_URL_HERE", image: stockyImg.url },
  { id: 20, name: "Amelia", category: "Appointment Booking", description: "Bookings, calendars and service scheduling.", icon: "CalendarCheck", demoUrl: "DEMO_URL_HERE", image: ameliaImg.url },
  { id: 21, name: "Homzen", category: "Real Estate / Laravel", description: "Property listings, agents and enquiry management.", icon: "Home", demoUrl: "DEMO_URL_HERE", image: homzenImg.url },
];
